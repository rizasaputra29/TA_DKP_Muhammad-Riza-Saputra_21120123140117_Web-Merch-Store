...
<body>
    ...
    <div class="container">
        ...
        <section id="Hits_Albums">
            ...
            $albumQueue->enqueue(new Album("Cintailah Cinta", "assets/img/cintailah cinta.png", "Rp. 150.000"));
            $albumQueue->enqueue(new Album("Kerajaan Cinta", "assets/img/kerajaan cinta.png", "Rp. 150.000"));
